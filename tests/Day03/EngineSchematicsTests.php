...
class EngineSchematicsTests extends TestCase
{
    ...
    public static function sets2(): array
    {
        return [
            ...
            ["23.43\n..*..", 23 * 43],
            ["..*..\n23.43", 23 * 43],
            'too many neighbors' => [".12..\n.1*..\n23.43", 0],
            [".2*..\n23...\n..*43", 2*23 + 23*43],
            ["*1...\n23...\n1.*..", 23],
            ["*1.1*\n23.14\n1.*..", 23+14+ 14*23],
            ["*1.1*\n23.14\n1.*..", 23+14+ 14*23],
            ["*1.1*\n23*14\n1.*5*", 23+14+ 14*5],
            ["*1#1*\n23414\n1234*", 23414*2 + 23414*1234],
            ["..345&%\n...*...\n#@567/$", 567*345],
            ["467..114..\n...*......\n..35.*633.\n......#...\n617*......\n.....+.58.\n..592.....\n......755.\n...$.*....\n.664.598..", 467835],
            [self::SCHEMATIC, 72246648],
            [self::SCHEMATIC_PART, 36*996 + 35*453 + 692*40 + 863*470 + 475*587 + 535*445 + 79*660 + 649*926 + 848*87 + 870*874
                + 415*825 + 846*444 + 689*160 + 610*82 + 422*59 + 693*297 + 768*56 + 700*560 + 39*381 + 171*529 + 565*194 +
                481*247 + 116*324 + 824*876 + 41*338 + 70*747 + 892*317 + 261*987 + 199*660 + 978*259 + 48*596 + 323*292 +
                945*699 + 264*212 + 13*8]
            ];
    }
    ...
    private const SCHEMATIC_PART = '............677..........................................................................227.....730..35.......318...........92...166.......
...
140........2*....285...836&..........13.8.............264.............945...............*............323....514.&.........-......%..........';
    ...
    private const SCHEMATIC = '............677..........................................................................227.....730..35.......318...........92...166.......
....%..863..#......................36.............956..337%......692..............*744....$..........*......../.....187..-..................
..346...*.....475.440....903&..996*...404+.395...*..............*.......&253.223.....................453..535......@....265.....290$........
.........470.*.....+..........................*.........148...40....361...................883.............*....%............649.............
.............587..........#..........848*.............../.........................................415....445....947............*...509......
